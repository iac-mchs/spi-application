...
class MapZoomButtonsOptions extends LayerOptions {
  final int minZoom;
  final int maxZoom;
  final bool mini;
...
class MapZoomButtonsPlugin implements MapPlugin {
  @override
  Widget createLayer(
      LayerOptions options, MapState mapState, Stream<Null> stream) {
    if (options is MapZoomButtonsOptions) {
  ...
  bool supportsLayer(LayerOptions options) {
    return options is MapZoomButtonsOptions;
  }
}

class ZoomButtons extends StatelessWidget {
  final MapZoomButtonsOptions zoomButtonsOpts;
  final MapState map;
